...
internal class LoopCheckerObsolete2
{
    public const int InitialArray = 4;

    public static AsyncLocal<LoopChecker> AsyncLocalInstance = new();

    public LoopCheckerObsolete2()
    {
    }

    public LoopCheckerObsolete2(LoopCheckerObsolete2 loopChecker)
    {
    ...
    public LoopCheckerObsolete2 Clone() => new(this);
